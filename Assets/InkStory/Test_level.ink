...
+ 我是来收保护费的	   @SpeechArt:Normal  @Speaker:Player    
~ StateChange(0,1,0,0,-1)
我是来收保护费的	#Speaker:Player 
-> b_first

+ 我是来做应该做的事情的	   @SpeechArt:Normal  @Speaker:Player    
~ StateChange(0,0,0,-1,-1)
我是来做应该做的事情的	#Speaker:Player 
-> b_first

+ 请问你是那位？	   @SpeechArt:Normal  @Speaker:Player    
...
+ 我不太清楚你指的什么	   @SpeechArt:Normal  @Speaker:Player    
~ StateChange(0,0,0,1,-1)
我不太清楚你指的什么	#Speaker:Player 
-> b_frist_one

+  我劝你少管闲事 	   @SpeechArt:Threaten  @CanUse:{ChoiceCanUse(0,0,0,-6)}    @Speaker:Player    
我劝你少管闲事 	#Speaker:Player 
~ judgeSuccess=TalkJudge(0,0,0,-6)
{judgeSuccess==true:
    ->E_one
    - else:
    ->E_two    
...
+ 我和他们不是一伙人，我会妥善处理这件事	   @SpeechArt:Cheat  @CanUse:{ChoiceCanUse(0,3,-3,3)}    @Speaker:Player    
我和他们不是一伙人，我会妥善处理这件事	#Speaker:Player 
~ judgeSuccess=TalkJudge(0,3,-3,3)
{judgeSuccess==true:
    ->E_one
    - else:
    ->E_two    
...
+  [我讨厌被人质问] 	   @SpeechArt:Threaten  @CanUse:{ChoiceCanUse(0,0,-4,-4)}    @Speaker:Player    
	#Speaker:Player 
你握紧拳头	#Speaker:Dialogue 

我讨厌被人质问，我更习惯用暴力回答问题。	#Speaker:Player 

~ judgeSuccess=TalkJudge(0,0,-4,-4)
{judgeSuccess==true:
    ->E_one
    - else:
    ->E_two    
...
+ 我只是做该做的而已。	   @SpeechArt:Pursuade  @CanUse:{ChoiceCanUse(-2,0,0,2)}    @Speaker:Player    
我只是做该做的而已。	#Speaker:Player 
~ judgeSuccess=TalkJudge(-2,0,0,2)
{judgeSuccess==true:
    ->E_one
    - else:
    ->b_one_two    
...
+ 我们只是在保护他们免受伤害。	   @SpeechArt:Cheat  @CanUse:{ChoiceCanUse(0,0,3,3)}    @Speaker:Player    
我们只是在保护他们免受伤害。	#Speaker:Player 
~ judgeSuccess=TalkJudge(0,0,3,3)
{judgeSuccess==true:
    ->E_one
    - else:
    ->E_two    
...
+ 闪开，否则我就要动手了	   @SpeechArt:Threaten  @CanUse:{ChoiceCanUse(0,0,0,-3)}    @Speaker:Player    
闪开，否则我就要动手了	#Speaker:Player 
~ judgeSuccess=TalkJudge(0,0,0,-3)
{judgeSuccess==true:
    ->E_one
    - else:
    ->E_two    
...
+ 他们接受我们的保护，没有我们他们早就因为黑户被管理局抓走了。	   @SpeechArt:Pursuade  @CanUse:{ChoiceCanUse(0,2,3,0)}    @Speaker:Player    
他们接受我们的保护，没有我们他们早就因为黑户被管理局抓走了。	#Speaker:Player 
~ judgeSuccess=TalkJudge(0,2,3,0)
{judgeSuccess==true:
    ->E_one
    - else:
    ->E_two    
...
+ 我们会提供帮助保障他们的生活的。	   @SpeechArt:Cheat  @CanUse:{ChoiceCanUse(0,2,2,2)}    @Speaker:Player    
我们会提供帮助保障他们的生活的。	#Speaker:Player 
~ judgeSuccess=TalkJudge(0,2,2,2)
{judgeSuccess==true:
    ->E_one
    - else:
    ->E_two    
...
+ 你并不知道发生了什么，这件事与你无关	   @SpeechArt:Pursuade  @CanUse:{ChoiceCanUse(0,2,0,-2)}    @Speaker:Player    
你并不知道发生了什么，这件事与你无关	#Speaker:Player 
~ judgeSuccess=TalkJudge(0,2,0,-2)
{judgeSuccess==true:
    ->E_one
    - else:
    ->E_two    
...
+ 我劝你少管闲事，你挡着我的路了	   @SpeechArt:Threaten  @CanUse:{ChoiceCanUse(0,0,-2,-6)}    @Speaker:Player    
我劝你少管闲事，你挡着我的路了	#Speaker:Player 
~ judgeSuccess=TalkJudge(0,0,-2,-6)
{judgeSuccess==true:
    ->E_one
    - else:
    ->E_two    
...
+ 我不确定，但我会尽力达成。	   @SpeechArt:Pursuade  @CanUse:{ChoiceCanUse(0,-3,7,0)}    @Speaker:Player    
我不确定，但我会尽力达成。	#Speaker:Player 
~ judgeSuccess=TalkJudge(0,-3,7,0)
{judgeSuccess==true:
    ->END
    - else:
    ->E_two    
...
+ 我目前只知道这笔钱是我们应得的，其他的不归我管，但我可以帮你去找其他人问问。	   @SpeechArt:Cheat  @CanUse:{ChoiceCanUse(0,0,0,5)}    @Speaker:Player    
我目前只知道这笔钱是我们应得的，其他的不归我管，但我可以帮你去找其他人问问。	#Speaker:Player 
~ judgeSuccess=TalkJudge(0,0,0,5)
{judgeSuccess==true:
    ->END
    - else:
    ->E_two    
