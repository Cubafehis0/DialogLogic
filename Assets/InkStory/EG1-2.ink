...
+ 加大力度再敲几次门并且大声叫喊	   @SpeechArt:Normal  @Speaker:Player    @StateChange:(0,1,0,0,-1)  
	#Speaker:Player 
	-> narrator_two
...
+ 你受到了我们的保护，应该交保护费	   @SpeechArt:Pursuade  @CanUse:(0,3,0,0)    @Success:5  @Fail:5  @Speaker:Player    
...
+ 你怎么可能没钱？	   @SpeechArt:Threaten  @CanUse:(0,0,0,-3)    @Success:5  @Fail:5  @Speaker:Player    
...
+ 我知道你把值钱的东西藏在那里	   @SpeechArt:Cheat  @CanUse:(0,5,0,0)    @Success:5  @Fail:5  @Speaker:Player    @StateChange:(0,0,0,1,-1)  
...
+ 因为我们你才能过的安稳，当然要交钱给我们。	   @SpeechArt:Pursuade  @CanUse:(0,3,0,0)    @Success:5  @Fail:5  @Speaker:Player    
	#Speaker:Player 
	{judgeSuccess==true:
    ->b_three
    - else:
...
+ 那你什么时候能有钱给我？	   @SpeechArt:Pursuade  @CanUse:(0,2,0,0)    @Success:5  @Fail:5  @Speaker:Player    
...
+ 如果没钱你怎么能在这住？	   @SpeechArt:Threaten  @CanUse:(0,0,0,-3)    @Success:5  @Fail:10  @Speaker:Player    
...
+ 我就是来收保护费的	   @SpeechArt:Pursuade  @CanUse:(0,3,0,0)    @Success:5  @Fail:5  @Speaker:Player    
...
+ 没什么，只是来看看你的	   @SpeechArt:Pursuade  @CanUse:(0,3,0,0)    @Success:5  @Fail:5  @Speaker:Player    
...
+ 少废话，把钱交出来	   @SpeechArt:Threaten  @CanUse:(0,2,0,0)    @Success:5  @Fail:10  @Speaker:Player    
...
+ 你没钱没关系，听说你还有个妹妹？	   @SpeechArt:Threaten  @CanUse:(0,-3,0,-3)    @Success:5  @Fail:10  @Speaker:Player    
你没钱没关系，听说你还有个妹妹？	#Speaker:Player 
{judgeSuccess==true:
    ->b_two_one
    - else:
      ->b_two    
...
+ 那你还有什么好说的？赶快把钱给我。	   @SpeechArt:Threaten  @CanUse:(0,-3,0,-3)    @Success:5  @Fail:15  @Speaker:Player    
...
+ 我给你想想办法，你可以去我们赌场做事抵钱，我们正缺人手呢	   @SpeechArt:Pursuade  @CanUse:(0,4,0,0)    @Success:5  @Fail:5  @Speaker:Player    
...
+ 我也是干活求生计的，我做不了主我也很难办啊	   @SpeechArt:Pursuade  @CanUse:(0,2,0,0)    @Success:5  @Fail:5  @Speaker:Player    
我也是干活求生计的，我做不了主我也很难办啊	#Speaker:Player 
{judgeSuccess==true:
    ->b_three_one
    - else:
      ->b_three    
...
+ 借啊	   @SpeechArt:Threaten  @CanUse:(0,-2,0,0)    @Success:5  @Fail:10  @Speaker:Player    
借啊 #Speaker:Player 
{judgeSuccess==true:
    ->b_first_two
    - else:
...
+ 你已经拖了很久了，宽限这件事我觉得不行	   @SpeechArt:Pursuade  @CanUse:(0,3,0,0)    @Success:5  @Fail:5  @Speaker:Player    
...
+ 你已经拖得够久了吧，你是想赖账吗？	   @SpeechArt:Threaten  @CanUse:(0,-2,0,0)    @Success:5  @Fail:15  @Speaker:Player    
