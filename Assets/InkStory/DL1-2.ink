...
+ 想要整治黑帮，我需要他们的外貌特征来认出他们，需要他们的出没时间来蹲守他们，还需要你配合我提供更多信息	   @SpeechArt:Pursuade  @CanUse:(0,4,3,0)    @Success:5  @Fail:5  @Speaker:Player    
...
+ 你走上前，用锐利眼神直视他，说道：“别把这不当回事，那天黑帮上门寻仇，你以为一把枪能保得住你的命？”	   @SpeechArt:Pursuade  @CanUse:(0,5,2,0)    @Success:5  @Fail:10  @Speaker:Player    @StateChange:(0,0,1,0,-1)  
...
+ 再次敲门询问	   @SpeechArt:Pursuade  @CanUse:(0,4,3,0)    @Success:5  @Fail:10  @Speaker:Player    
...
+ 重重地叩击房门	   @SpeechArt:Pursuade  @CanUse:(0,3,0,4)    @Success:5  @Fail:10  @Speaker:Player    
...
+ 我不需要知道，只需要让你告诉我就行了	   @SpeechArt:Threaten  @CanUse:(0,-2,-2,-4)    @Success:5  @Fail:10  @Speaker:Player    
...
+ 你掏出手枪，“我觉得你还是老实交代吧，不然我不保证你的安全。'	   @SpeechArt:Threaten  @CanUse:(0,-3,-3,-4)    @Success:5  @Fail:15  @Speaker:Player    
