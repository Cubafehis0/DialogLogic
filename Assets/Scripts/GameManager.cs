...
public class GameManager : MonoBehaviour
{
    ...
    private MissionSystem missionSystem = null;
    ...
    public MissionSystem MissionSystem { get => missionSystem; }
    ...
    void Start()
    {
        ...
        LoadMissions(Path.Combine(Application.streamingAssetsPath, "MissionsInfo.xml"));
    ...
    {
        using FileStream fs = new FileStream(path, FileMode.Open, FileAccess.Read);
        missionSystem = new MissionSystem(XmlUtilty.Deserialize<MissionsInfo>(fs));
    }
