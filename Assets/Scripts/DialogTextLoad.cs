...
public class DialogTextLoad : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        DialogNarratagePanel = canvas.transform.Find("DialogNarratagePanel");
    ...
    public void BeginDialog()
    {
        ...
        //RemoveChildren(DialogChoosePanel.gameObject);
        //ShowDialog();
        if (DialogPanel.childCount == 0 && DialogNarratagePanel.childCount == 0)
        {
    ...
    private void ShowDialogChoose()
    {
        ...
        if (choices.Count > 0 && DialogChoosePanel.childCount == 0)
        {
            ...
            for (var i = 0; i < choices.Count; i++)
            {
                ...
                {
                    Debug.Log("isLocked");
                    choiceButton.GetComponent<ButtonScript>().canChoose = false;
                }
                else
                {
                    Debug.Log("大大大于0啦");
    ...
    public void OnClickChoiceButton(Choice choice, GameObject button)
    {
        ...
        RemoveChildren(DialogChoosePanel.gameObject, button);
